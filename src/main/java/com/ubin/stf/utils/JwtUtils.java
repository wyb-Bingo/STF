...
public class JwtUtils {
    ...
    public static final long DEFAULT_TOKEN_TIME_MS = 60 * 60 * 24 * 1000;
   ...
   */
     ...
     * 签名秘钥
     */
    public static final String SECRET = "ubin@13530834836";
